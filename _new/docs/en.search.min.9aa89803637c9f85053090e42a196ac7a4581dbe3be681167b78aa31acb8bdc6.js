...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.861865b1b3fbdfb03305a1770afa873acdfc92dc2ee05689c8447f90b88f8399.js',function(){input.required=false;search();});}
