...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.39656d3b582709e7c93f62f55ba49c5552b1ae2bce792f37bca33c4415ba09b2.js',function(){input.required=false;search();});}
