...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.d9a3ca97a3bd2bbe9ce2acfa6e2612208d93367ace22bbc2c72abbc3284ec492.js',function(){input.required=false;search();});}
