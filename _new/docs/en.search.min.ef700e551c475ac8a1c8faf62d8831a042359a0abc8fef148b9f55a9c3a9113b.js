...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.1b9bd30439c01db949c05fdb7f7aec1fd5ab3b9ebfbf6f7c46ae01a7324255de.js',function(){input.required=false;search();});}
