...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.39abcb240e37e573e1e65a22a503532ddf745bc44d90dea11b35171bed2513d3.js',function(){input.required=false;search();});}
