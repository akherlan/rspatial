...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b33dfbdfbaa385049450a25a9a62de519d6208e529dc34f2466b07709af93225.js',function(){input.required=false;search();});}
