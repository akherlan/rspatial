...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.445a9e65a936c3ba4c417afefadb0b5942837bd3782fe9103034f6456e06110d.js',function(){input.required=false;search();});}
