...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c6171b1877382856e36eb389737f114918640bbd5a4ebc4234d61d0b76d57600.js',function(){input.required=false;search();});}
