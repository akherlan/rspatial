...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3ec14eb2a4fc290e0e3ea45309d0a0ebf57271c7ebca7fec5b1fec607da89b86.js',function(){input.required=false;search();});}
