...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.2b3516fb45edbb5dc5fe2b23f13a62ce4cc80f084d4cd57299889d54777bc34d.js',function(){input.required=false;search();});}
