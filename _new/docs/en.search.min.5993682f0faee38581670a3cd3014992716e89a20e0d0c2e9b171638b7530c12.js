...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.30afa7a551627579957a29fe77e12325d2b2fd797793e9822c9deb2e6dd8fb48.js',function(){input.required=false;search();});}
