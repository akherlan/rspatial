...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.313cdca860e1bccab2e58fa069accf72de032ddf868d63d0cfd628f841a5d5b3.js',function(){input.required=false;search();});}
