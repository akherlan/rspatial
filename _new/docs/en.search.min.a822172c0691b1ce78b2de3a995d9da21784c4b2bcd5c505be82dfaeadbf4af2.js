...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9385c59ae4523a3d2faca1c9564a81b760ffaf5aa994755bfc9cac132eb2d326.js',function(){input.required=false;search();});}
