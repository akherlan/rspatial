...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3b4add5929a112792c6bf6d51b7ca539b74fe4db526d2888243de21297b9f0cd.js',function(){input.required=false;search();});}
