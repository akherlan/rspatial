...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c23c9d9d8231246e95ecdae8a28f669013901043b4cee3e5d1a4b0a7c79d05a4.js',function(){input.required=false;search();});}
