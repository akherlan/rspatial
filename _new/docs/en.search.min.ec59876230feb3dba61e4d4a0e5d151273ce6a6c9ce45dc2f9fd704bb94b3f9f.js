...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.1868426a04049355f3bb0fcda62b6cc568a798b8ecc040a6c8971fe1cd9649c6.js',function(){input.required=false;search();});}
