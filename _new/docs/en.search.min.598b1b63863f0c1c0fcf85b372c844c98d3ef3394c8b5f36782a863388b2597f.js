...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.723015ddd5ed2981f4b0895f0e446de239ac636bf67afe5c6b7e42011c64f7a4.js',function(){input.required=false;search();});}
