...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.fa71759a099a6bd7fe1a7fff93f255034ab500581d22daab9199635e25f27a8e.js',function(){input.required=false;search();});}
