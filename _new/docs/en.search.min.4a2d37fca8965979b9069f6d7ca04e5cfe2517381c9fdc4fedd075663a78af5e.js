...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3dd33c80459fe2b0db2ffd039ff1e75a083789ed2f5307b37505258940595929.js',function(){input.required=false;search();});}
