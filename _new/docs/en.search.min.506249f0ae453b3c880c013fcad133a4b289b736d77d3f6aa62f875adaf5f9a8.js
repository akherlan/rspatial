...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e1a38a0e6f3009f6d87e8b2493ab0ac53e7a2866614f8fa21a416501de972ddf.js',function(){input.required=false;search();});}
