...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3b0a7fcb03e0e029e5fb8071757468c6183697530040fc1ec0d61db2da76b1ff.js',function(){input.required=false;search();});}
