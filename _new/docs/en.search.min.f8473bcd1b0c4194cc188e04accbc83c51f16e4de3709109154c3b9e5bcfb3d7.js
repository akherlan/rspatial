...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.14629f913d70b97dc0b297365ae1aec5eef2a9de1111beaaa08de3a83fee8ebd.js',function(){input.required=false;search();});}
