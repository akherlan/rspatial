...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.15b21527848f9852b90f5b74ebb183ebe2762f01d2705aedd385425a519facac.js',function(){input.required=false;search();});}
