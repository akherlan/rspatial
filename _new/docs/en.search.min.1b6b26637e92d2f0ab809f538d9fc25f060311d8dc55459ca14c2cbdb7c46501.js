...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.2903e7a3a9a5df796e9a368c234d0d96698068b432ddca2d65d4135a0dee397b.js',function(){input.required=false;search();});}
