...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.774ead9d60aeb4e2fbdac6e8748f2ffd0608fab7cc5bcfff3890b6a4565d8871.js',function(){input.required=false;search();});}
