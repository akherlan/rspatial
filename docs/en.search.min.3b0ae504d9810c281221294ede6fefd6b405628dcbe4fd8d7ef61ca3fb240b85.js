...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.5e221ae9f65108417a65af3275bc04bcf0df945292f857217cfac7efa1f50f40.js',function(){input.required=false;search();});}
