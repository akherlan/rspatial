...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.32d91037298079df2446d47dd61e99b4e3eb4e0e1e8d4f77eebfa41add00081e.js',function(){input.required=false;search();});}
