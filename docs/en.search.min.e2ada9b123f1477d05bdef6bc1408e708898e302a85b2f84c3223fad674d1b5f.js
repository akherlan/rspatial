...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.4e569c79814dcb7ec3ac3fa4d0a0bdb8382d33add720c4e62aa56afa3d61ff67.js',function(){input.required=false;search();});}
