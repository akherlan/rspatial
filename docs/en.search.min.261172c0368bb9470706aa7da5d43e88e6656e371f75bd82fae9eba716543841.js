...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.0fb30450a72d01f6780eaca0afea7fc8991d8386ff543f185cecb0b135480f39.js',function(){input.required=false;search();});}
