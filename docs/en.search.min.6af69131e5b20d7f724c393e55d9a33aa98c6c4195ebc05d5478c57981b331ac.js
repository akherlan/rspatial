...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.9b0cc050a37052274a9957bffc281a741ead89486565043450921497944083ea.js',function(){input.required=false;search();});}
