...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.b99a128128b6d95a0831202bcb8c0c89100e82bd1dcdcedb4ee23b66f029163f.js',function(){input.required=false;search();});}
