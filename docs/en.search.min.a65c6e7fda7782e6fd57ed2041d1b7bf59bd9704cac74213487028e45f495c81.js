...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.260378a786fc63d9360ce49203e3b9f90fed6abd9a12920ede76ddc2617bffe9.js',function(){input.required=false;search();});}
