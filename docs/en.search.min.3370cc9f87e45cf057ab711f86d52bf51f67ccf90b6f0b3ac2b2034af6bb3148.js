...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.8f06f027ecffb6c444888f5aadb665d9c2aee2a424ed6d956373f839a815b3c8.js',function(){input.required=false;search();});}
