...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.ee37629963404572377b65078d2c4d66dd8bdbba79cce27c52a7453e8e35b4ca.js',function(){input.required=false;search();});}
