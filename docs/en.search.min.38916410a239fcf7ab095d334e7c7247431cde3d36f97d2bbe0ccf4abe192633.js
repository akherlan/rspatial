...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.2a172eb226a89e1e18c09081fb41495a117da63af4376b448484a2e7132026c9.js',function(){input.required=false;search();});}
