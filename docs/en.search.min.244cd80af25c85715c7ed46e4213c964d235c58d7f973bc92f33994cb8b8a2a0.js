...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.0a6b4d88194d4073445aaf6a791318e95a6f19256be295ab0dfd5d8f2ab6c2d3.js',function(){input.required=false;search();});}
