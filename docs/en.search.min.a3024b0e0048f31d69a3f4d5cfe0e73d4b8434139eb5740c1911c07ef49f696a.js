...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.6c1afdeed1b87aeda9aae6244f39cd6d3f6a34cf30bbb2afe8de5f621ef058fe.js',function(){input.required=false;search();});}
