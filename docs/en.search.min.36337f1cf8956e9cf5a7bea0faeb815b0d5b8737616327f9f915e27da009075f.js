...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.1a6147f8a3e1cd4d0ad5e741ce15e20bc952be1e5143df4b254cf09b398638f5.js',function(){input.required=false;search();});}
