...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.2bf053357dd9427e5e1819e5637d6923dae707f485a001c2045413d478bea55c.js',function(){input.required=false;search();});}
