...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.8b54a316d49f825c7e7ff89c28a9666dd1a8ff7b95ffbfe768ea75a6cba26660.js',function(){input.required=false;search();});}
