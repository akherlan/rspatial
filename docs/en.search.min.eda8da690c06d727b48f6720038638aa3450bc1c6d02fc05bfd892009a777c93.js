...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.378cd5c46628a8b2b606279e0febc7358dffd066274cbacdf496af68c9759d8b.js',function(){input.required=false;search();});}
