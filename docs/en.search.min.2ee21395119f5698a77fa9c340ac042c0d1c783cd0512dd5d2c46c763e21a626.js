...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.40c07ad2a534d71d68ff609b973868f550d19a51d6fa5af8893496afb35947a8.js',function(){input.required=false;search();});}
