...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.a54fa3d2c42408ad59f303db70de430319c0b5f10a7a2b5812f8702fba66842e.js',function(){input.required=false;search();});}
