...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.2bde735efdc194f4717e040cafd519b60f6ed544c39285e50938506262d77a6d.js',function(){input.required=false;search();});}
