...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.1dcdf7ca040a144a71cacddca852f30d5f0979fbc0af82ecd5829f9250e0229d.js',function(){input.required=false;search();});}
