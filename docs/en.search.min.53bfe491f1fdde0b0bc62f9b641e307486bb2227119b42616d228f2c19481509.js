...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.1d2375fac543e89f1f02614d818e5d627b7e8bf5686cd1eafd18a1d87a64fcf4.js',function(){input.required=false;search();});}
