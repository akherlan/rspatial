...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.3d416bf430ac23db9ad379eb50848a12dd6e96248cebc134783c3ef42bf931a3.js',function(){input.required=false;search();});}
