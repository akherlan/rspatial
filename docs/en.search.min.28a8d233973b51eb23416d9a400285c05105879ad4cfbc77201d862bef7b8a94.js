...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.cc4d64a0726f7a8cdd08b608b5864ef075549090b3e022e29b101a3143635ca9.js',function(){input.required=false;search();});}
