...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.781413420f737129f24dec3feea52c6dd2b88b85d00080ae02daad83d23a9604.js',function(){input.required=false;search();});}
