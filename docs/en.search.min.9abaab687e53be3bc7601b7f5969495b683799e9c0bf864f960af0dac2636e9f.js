...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.1575eeed770c4086d12961dcd9c424d6152c948cc17a1c62d6038181e457ca31.js',function(){input.required=false;search();});}
