...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.a6fe2f4fefd95b41d4ad37a51d4ae0031739d9a6bef6a7500d90bd4494bcec07.js',function(){input.required=false;search();});}
