...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.57e287126d6ced2131e60949d9255334fa31a9562173835199bbe9e656506a44.js',function(){input.required=false;search();});}
