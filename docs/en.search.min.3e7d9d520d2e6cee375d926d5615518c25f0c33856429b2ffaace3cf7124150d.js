...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.f1bc214515e94217681dea638cc9fc6070117741f01435bbf0f19a5faf2177fa.js',function(){input.required=false;search();});}
