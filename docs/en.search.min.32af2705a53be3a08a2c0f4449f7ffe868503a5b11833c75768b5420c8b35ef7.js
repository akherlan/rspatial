...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.3901c83692d798d0130296a289cd66c7186d7b9ffcdfe6a30de0a812ec5a5f0f.js',function(){input.required=false;search();});}
