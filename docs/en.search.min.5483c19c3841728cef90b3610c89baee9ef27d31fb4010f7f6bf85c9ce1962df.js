...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.ca82b029539c8dfe1bba5dae20d6161cf704f3092d030b876b1d0d178338882f.js',function(){input.required=false;search();});}
