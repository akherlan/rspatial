...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.09a129f2f1afa56804905049e0024e371513326176946e1ae31ab48ed143ec75.js',function(){input.required=false;search();});}
