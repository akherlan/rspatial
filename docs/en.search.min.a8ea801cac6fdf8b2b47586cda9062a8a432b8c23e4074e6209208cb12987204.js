...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.18beb52d3ccd99b01dbfba70acae1b87f1620e14e6315a8ab6b50625bbb6e8df.js',function(){input.required=false;search();});}
