...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.90b1e2669f91ad38be7bddabb2dbd6c30a46d25b5bfa1658f72b3a081b99560e.js',function(){input.required=false;search();});}
