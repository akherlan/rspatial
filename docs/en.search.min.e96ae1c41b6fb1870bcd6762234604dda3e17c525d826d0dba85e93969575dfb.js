...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.38d995a764e753e9356c8a2d1838f00767207447a3d6b9a3cc3a91eb67ba68bb.js',function(){input.required=false;search();});}
