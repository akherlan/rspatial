...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.1dcaf01c4a82ca495cf08420364c0cb45c0bdfe7ea6188f13d6e5e37dbadbced.js',function(){input.required=false;search();});}
