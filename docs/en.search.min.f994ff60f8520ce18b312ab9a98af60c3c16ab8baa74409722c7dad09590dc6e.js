...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.601e66b902b6e2a09a1920e08934ec0b767745567040844246b9f8e0e4d6de6e.js',function(){input.required=false;search();});}
