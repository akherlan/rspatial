...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.39feb7e06fc12d5fad9c4248267bdd6578097f01bd6e9e1a51c066df7236dc94.js',function(){input.required=false;search();});}
