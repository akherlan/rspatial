...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.0d484ca2400ef37ae3b1e16fac3a1d32dc48b5ba0a48e6910d9680a569cccb89.js',function(){input.required=false;search();});}
