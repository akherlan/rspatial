...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.fe9bf2d6c6f35fbe0fb7bdbca1d5d08f77ab8f953caa619f214a5a426dfc0fac.js',function(){input.required=false;search();});}
