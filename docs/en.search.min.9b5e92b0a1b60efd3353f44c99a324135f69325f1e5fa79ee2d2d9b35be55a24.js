...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.1d113da4c8360bc110edcbe9be0442b5831fbe25d138e23caf4fdda75e0f27ad.js',function(){input.required=false;search();});}
