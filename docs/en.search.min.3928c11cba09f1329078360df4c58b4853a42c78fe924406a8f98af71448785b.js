...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.32a592f308d9d6f475611c549d5ba49382fa3faccdc76e2ac45b7ac0d5179a02.js',function(){input.required=false;search();});}
