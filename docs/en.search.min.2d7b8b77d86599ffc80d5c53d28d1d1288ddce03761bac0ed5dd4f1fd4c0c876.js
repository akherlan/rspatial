...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.c589441fcbd66de61107b96e9a60f345c0118157964ccf41b82982544bec3426.js',function(){input.required=false;search();});}
