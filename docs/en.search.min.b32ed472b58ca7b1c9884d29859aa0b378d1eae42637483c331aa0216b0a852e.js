...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.01b6eca46bf7e7feb5327c53ac8abeb2baae1e14a25e8e17a6767fceac89547d.js',function(){input.required=false;search();});}
