...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.83683eea4f2d2935b373a186327246366d6f94f52b8d099a81bbc36d6d12cab3.js',function(){input.required=false;search();});}
