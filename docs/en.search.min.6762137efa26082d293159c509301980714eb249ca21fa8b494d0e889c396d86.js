...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.806584d270b0823ae421d380da5955f26fa4d605d2aad2b66157e2d80db7fc6d.js',function(){input.required=false;search();});}
