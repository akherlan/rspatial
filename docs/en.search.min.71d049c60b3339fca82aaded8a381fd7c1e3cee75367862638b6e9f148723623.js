...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.745fc36bf99d223cd2e5fefaa0d2249144f634dd0e5b43184a971ccc328d2a83.js',function(){input.required=false;search();});}
