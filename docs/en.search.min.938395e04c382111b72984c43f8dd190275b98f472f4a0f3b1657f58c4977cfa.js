...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.e231a5ad305c9456a0307f2dd7f8d5532bd57887c1759c398cd6b86495fbdaf7.js',function(){input.required=false;search();});}
