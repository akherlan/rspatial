...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.5fbd10f2b42a3e99278dd19a903fc60ee57c0d96a190e7f73b01d928b9d01a89.js',function(){input.required=false;search();});}
