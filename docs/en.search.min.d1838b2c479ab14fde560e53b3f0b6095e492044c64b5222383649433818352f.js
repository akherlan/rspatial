...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.fcadfe9716f5e7f56523f22870f042cca091ac6b5a2bcf0eb5df47aff6eb05e4.js',function(){input.required=false;search();});}
