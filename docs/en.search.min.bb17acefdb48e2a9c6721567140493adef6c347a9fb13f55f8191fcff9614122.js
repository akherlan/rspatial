...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.08589f60d1f506a57419b47915fb39c7dd0c655fb7281d3c4df59dbab051b9bf.js',function(){input.required=false;search();});}
