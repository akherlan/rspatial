...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.9425da233d49f23065480249889bbcaa6c32e4b5037ed71b469b3de7307f6fb4.js',function(){input.required=false;search();});}
