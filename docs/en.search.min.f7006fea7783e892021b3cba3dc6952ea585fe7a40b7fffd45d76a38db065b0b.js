...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.19a42e1e3c44ae2a499d9c5fb47b6798fd32ff61bda67c8ee5f91f5fdf963114.js',function(){input.required=false;search();});}
