...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.2b839b3d3b6cd94d4acb1242436710812d5dbbba26aa93fda6879cbd984ab846.js',function(){input.required=false;search();});}
