...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.45b35b924320e776bd293bbfb0973794ba372fe50f659a378eb38d10d9731a1a.js',function(){input.required=false;search();});}
