...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.c23de97b282d3edd118ada364ff6b148ec5a5c6154294fee9d549a71eea23d3e.js',function(){input.required=false;search();});}
