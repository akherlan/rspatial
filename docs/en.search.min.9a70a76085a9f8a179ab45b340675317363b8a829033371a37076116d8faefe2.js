...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.eba9e21d92e9dc4b1eeda5aecd66fe344f7d2e75b3b79093be6eff4a923c691f.js',function(){input.required=false;search();});}
