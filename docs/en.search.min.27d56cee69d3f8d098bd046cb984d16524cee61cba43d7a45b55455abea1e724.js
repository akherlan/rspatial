...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.899944e138543544e44c8695958adc7075b5d1cb7d8b1d8b8b57f06270e98ffe.js',function(){input.required=false;search();});}
