...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.ba305cb2ed92fdf61e9307acde11b13ca4fb551c7ee2373cea70195544ad16cd.js',function(){input.required=false;search();});}
