...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.4262f00f85128a5cd1d8a7dd027d43bdfc5a3f7cbef168419f63325a4e81173d.js',function(){input.required=false;search();});}
