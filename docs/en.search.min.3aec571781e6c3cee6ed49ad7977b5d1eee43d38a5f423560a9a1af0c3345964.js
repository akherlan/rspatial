...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.0528cad06c31aec15c2c113d517d5aefc28a92ceb2bb945151492ff45c3a9d7b.js',function(){input.required=false;search();});}
