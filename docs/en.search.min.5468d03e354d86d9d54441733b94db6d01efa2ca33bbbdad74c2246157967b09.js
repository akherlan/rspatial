...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.270d9809e33eec2e15c63b51b3d132f4fd2e7557a7cda9302fdedf89f8e1dba4.js',function(){input.required=false;search();});}
