...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.1e1d2330c47e9db4e82ef77e0bdb475ce4b00e02511f2ebcf292d7f017ffd554.js',function(){input.required=false;search();});}
