...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.e5958337c1dfad535c6850b0a1ea7d8812f49750366083669855442a4504fa63.js',function(){input.required=false;search();});}
