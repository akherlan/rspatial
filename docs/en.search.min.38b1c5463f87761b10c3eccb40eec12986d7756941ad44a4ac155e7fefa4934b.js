...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.ecbb1e466af08ba7651b824156a549128342c409a2ef348cb5fb4d6a7c146ce6.js',function(){input.required=false;search();});}
