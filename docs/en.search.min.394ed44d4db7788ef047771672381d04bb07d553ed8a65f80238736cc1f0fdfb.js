...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.681163b17fc1635a5a25877a512eb03f56aa56fe7cb0537120bda9487e60742a.js',function(){input.required=false;search();});}
