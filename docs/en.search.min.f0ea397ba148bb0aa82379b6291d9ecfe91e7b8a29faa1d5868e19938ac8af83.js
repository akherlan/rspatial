...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.6d53453527909661a21aa61e69a0cd5b71fd39c13a9af780fa36bdf998f65b86.js',function(){input.required=false;search();});}
