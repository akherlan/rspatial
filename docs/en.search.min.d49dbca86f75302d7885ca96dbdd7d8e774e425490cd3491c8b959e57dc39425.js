...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.cfd771e3e50592dbce0ec0ed1aefbfdbf99c748acd9643c7e208fc8295537034.js',function(){input.required=false;search();});}
