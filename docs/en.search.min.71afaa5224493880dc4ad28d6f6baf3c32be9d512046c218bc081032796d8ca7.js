...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.8d33d840c7b496b57cfcea6c6ee0b3d0b05e58acc84a532e68d6eda3e7c391ec.js',function(){input.required=false;search();});}
