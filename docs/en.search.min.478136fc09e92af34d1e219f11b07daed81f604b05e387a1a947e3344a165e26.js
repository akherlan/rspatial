...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.357691fc282c7fb16959eddc62aef950b346e547d36c7367ae98d4831dbd566a.js',function(){input.required=false;search();});}
