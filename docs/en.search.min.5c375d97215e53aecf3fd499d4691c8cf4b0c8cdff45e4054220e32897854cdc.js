...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.5b957452e975ae9739458c6ae3fb067cce78ce4db023f11412be9a3e94c33b23.js',function(){input.required=false;search();});}
