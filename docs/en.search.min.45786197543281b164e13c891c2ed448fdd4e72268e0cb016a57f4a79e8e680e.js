...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.e42a2e30c30a4a49f8af84d4262135fd982512765a27fff43681dfb14f5195eb.js',function(){input.required=false;search();});}
