...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.a839a7ab6433d4b0a9d376a085721821e19e414db50bf3e9f7704fc2e555cc5f.js',function(){input.required=false;search();});}
