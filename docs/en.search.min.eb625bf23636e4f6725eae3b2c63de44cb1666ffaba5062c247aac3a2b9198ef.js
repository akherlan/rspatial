...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.cf7cd6d0ddc7116777c09a984d493088dbf03aae1e5d939f6d0e7a015cffa774.js',function(){input.required=false;search();});}
