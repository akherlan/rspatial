...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.b0cf800a8fe3fb406d53c3090c83a4021862663fdd2b695cabfec241b19e3125.js',function(){input.required=false;search();});}
