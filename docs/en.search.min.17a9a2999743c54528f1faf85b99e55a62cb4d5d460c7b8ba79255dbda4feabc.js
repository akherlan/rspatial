...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.d19a034c25c5945d0dec5e660003d8abe08b7a2034005a159a1464718b68d36b.js',function(){input.required=false;search();});}
