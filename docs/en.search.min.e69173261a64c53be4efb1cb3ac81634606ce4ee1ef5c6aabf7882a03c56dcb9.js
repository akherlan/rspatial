...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.db4c5a33cb66d9b6515f4813ec19341ed0040393268eaca519c5369c31003bc2.js',function(){input.required=false;search();});}
