...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.21979baeb91de7ca1d3b52f61163a57212870930e884d7106deccaf653c6ecfe.js',function(){input.required=false;search();});}
