...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.00bdba3399f2c9a00ac8fb0a027c537bc61ebb9266981f954e1e259a95440ea3.js',function(){input.required=false;search();});}
