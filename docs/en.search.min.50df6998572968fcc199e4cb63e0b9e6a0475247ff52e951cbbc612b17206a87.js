...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.809f69bf8a9b884956c41be6d76340ec42401d89b34d0acc3b5041a3102a9e4e.js',function(){input.required=false;search();});}
