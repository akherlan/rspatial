...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.6bcbb44d109a857e9e6063bda5136d994c7efcdf59b5ea82cbe03ba0723cdf75.js',function(){input.required=false;search();});}
