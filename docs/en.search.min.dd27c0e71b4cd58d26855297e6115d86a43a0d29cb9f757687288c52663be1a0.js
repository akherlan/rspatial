...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.44e158711b7d4aedc78befc9724aad50062c2032f84a556607048188d5a3d551.js',function(){input.required=false;search();});}
