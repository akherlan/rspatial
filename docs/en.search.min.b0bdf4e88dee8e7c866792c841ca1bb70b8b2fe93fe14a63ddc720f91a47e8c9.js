...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.7e2863ee71039334446f560ea39f3acd2b53629266ee7ad5caacff0271615e68.js',function(){input.required=false;search();});}
