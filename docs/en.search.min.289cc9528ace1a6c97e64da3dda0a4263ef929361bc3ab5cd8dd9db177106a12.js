...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.0a09081f9abdb98c3bb1240bc64a951f23aebeb418aad5e7343bd2a9fdd86dcf.js',function(){input.required=false;search();});}
