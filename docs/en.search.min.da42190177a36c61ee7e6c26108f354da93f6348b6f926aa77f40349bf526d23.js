...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.1306c846adff64e1008fc768bea427f30069118bec612c7d9511a5620d7d01f6.js',function(){input.required=false;search();});}
