...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.93c93767f21367d405287b4c008394690ec62196e58f24d8b3d0e0e4a0311a47.js',function(){input.required=false;search();});}
