...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.fb71aae20e3bcc968abcadfba71ad67d44716ad3ae4a8210bab9fb7d8be73e11.js',function(){input.required=false;search();});}
