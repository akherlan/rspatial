...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.f3635f8d7b2bb05a49a674b6a746df1df37f3bbbb82c8644872eb036d95169cd.js',function(){input.required=false;search();});}
