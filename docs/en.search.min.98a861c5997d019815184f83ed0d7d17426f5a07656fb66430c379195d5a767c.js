...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.2d0ca05a6e09ead24c1f11bbf30c8c065f97ac95e979e43d89ce18c1e74c7d6d.js',function(){input.required=false;search();});}
