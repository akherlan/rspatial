...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.337bf3bd8a7ab10312470d98d175f1d5b5dd81ff420f55d4841e05b4e1bd5bf1.js',function(){input.required=false;search();});}
