...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.919b7d1b072535a9e1452b000ee92143bb35bb1c20558223813fdaa4e03fb879.js',function(){input.required=false;search();});}
