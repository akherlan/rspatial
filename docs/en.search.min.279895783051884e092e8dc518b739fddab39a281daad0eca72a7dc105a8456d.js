...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.72306aab83f1543aaaf6e656d7b093c7952c8ea40ed606da18e0ba70b0197dec.js',function(){input.required=false;search();});}
