...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.7d1943ef157835331f75c511e45b05ff27898a70c017ea69c0ba6a52af561db8.js',function(){input.required=false;search();});}
