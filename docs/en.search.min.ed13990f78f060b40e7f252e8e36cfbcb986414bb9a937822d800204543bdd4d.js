...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.dbcf18e57171e2cf48e453d202f662489dd5a0802fe798d408b9080ae3e37a5e.js',function(){input.required=false;search();});}
