...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.183f6d4bfb5064f23d155cbdd492998916257003ed020202fc78a9be7ff2137c.js',function(){input.required=false;search();});}
