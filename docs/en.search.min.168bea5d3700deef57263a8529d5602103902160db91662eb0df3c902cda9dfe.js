...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.2f02dcaf83c988a67f50bdcb9f9cc805dc289dc1c6017a5d79e9e7355ee6be54.js',function(){input.required=false;search();});}
