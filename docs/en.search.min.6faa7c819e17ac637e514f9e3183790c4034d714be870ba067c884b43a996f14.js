...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.d89918edbbbaea9db1590bef44c6b5cdf8ea8add0d5c4abb03f5df8980bd2716.js',function(){input.required=false;search();});}
