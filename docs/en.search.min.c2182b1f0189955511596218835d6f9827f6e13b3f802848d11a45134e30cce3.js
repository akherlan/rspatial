...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.9a556357db79bfbf08a87111116ba934bf54f04bde8c41b9082076a11f383e76.js',function(){input.required=false;search();});}
