...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.f533565af16d405a27ffc4006500b2d3c153cc21d69c4896f0ec5dc79ee7db58.js',function(){input.required=false;search();});}
