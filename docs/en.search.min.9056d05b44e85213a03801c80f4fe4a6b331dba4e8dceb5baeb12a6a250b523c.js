...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.557c3cb1f30142b3a52a3edea5472aaca7fba8914a2723d53eb564987bf7550c.js',function(){input.required=false;search();});}
