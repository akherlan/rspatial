...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.3e3803071487c1558b83308620d0a370471f1756a8ad3a176a3cbc867e833ecf.js',function(){input.required=false;search();});}
