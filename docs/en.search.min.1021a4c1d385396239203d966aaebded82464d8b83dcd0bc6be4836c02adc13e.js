...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.9442a0dfa42d6bebeeef9e0808d88740eec004eb6d72425621be1dac234a598e.js',function(){input.required=false;search();});}
