...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.cc4b9e12773085ca8ed2be9f18cc6529c6eca2e01bf44baa166ad42a328da0c2.js',function(){input.required=false;search();});}
