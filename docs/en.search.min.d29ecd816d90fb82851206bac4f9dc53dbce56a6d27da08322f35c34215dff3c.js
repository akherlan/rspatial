...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.be8b9a68b66dd66838c2d64326f539680e51e9343cd8928d23c1062ca68e0ff0.js',function(){input.required=false;search();});}
