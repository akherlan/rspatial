...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.c6b30f53e3f03baba27be1a6f5fe58336d03a2b74124a95c409ad66eb6a456e2.js',function(){input.required=false;search();});}
