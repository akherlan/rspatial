...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.1d7ce2147a5d43fb4fab4cb828a2b4573e5309958a23ea5cb878c83e60bbcd8e.js',function(){input.required=false;search();});}
