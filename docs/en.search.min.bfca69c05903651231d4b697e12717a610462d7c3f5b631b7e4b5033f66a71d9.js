...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.498b5a285fc57a15ae9d05961501f9cb5d4ddfa65993d175d7646e14fcedbbfa.js',function(){input.required=false;search();});}
