...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.7f28cc3dfa734ca09e5ee52c87659f2adab49a138de94fd4b7db9d65f6fd9607.js',function(){input.required=false;search();});}
