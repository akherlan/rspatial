...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.c066e6425835ced00aa1bc68ee7fcb26b9b001148f8bf3a5fcc659b7a9a9e072.js',function(){input.required=false;search();});}
