...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.f473c3a7605e2a89ab4d5ef59d7ac271ad11de5b8bce30410f352fbdf67d029f.js',function(){input.required=false;search();});}
