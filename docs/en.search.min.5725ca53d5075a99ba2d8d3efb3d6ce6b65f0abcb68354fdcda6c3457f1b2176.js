...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.7ba6fc5b21d7e30ac719ba179312b830f4808bf04fda363997314809f6728d5a.js',function(){input.required=false;search();});}
