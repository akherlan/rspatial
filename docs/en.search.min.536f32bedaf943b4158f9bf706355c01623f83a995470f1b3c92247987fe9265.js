...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.63a2e2d38bfa7d3fa22e9fafd3396362261cd8bd493bc2d4ca91f8ad3122be60.js',function(){input.required=false;search();});}
