...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.a31af7a2fb024e87029e5a64e403acb28add771d6bfe0fc7d9ad842f6ae5617d.js',function(){input.required=false;search();});}
