...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.f0e57b44f6bfa9713aceaa2ef45585bd570e7ebe412ba7f596f78a3347ba537e.js',function(){input.required=false;search();});}
