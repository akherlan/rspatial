...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.aa73820c2481de71a21f4503ce5b992600a0cfc1e6b20a0b4c0bec82995d8856.js',function(){input.required=false;search();});}
