...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.0339382d25c87dd377b669be54b56eab41815a0eae37b74f19e3905a21e4aa70.js',function(){input.required=false;search();});}
