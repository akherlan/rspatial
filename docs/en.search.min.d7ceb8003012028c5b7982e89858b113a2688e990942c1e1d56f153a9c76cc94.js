...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.4f334cbca4fb2c942609e366492d8c4b7072005346f3352c845c52121865f607.js',function(){input.required=false;search();});}
