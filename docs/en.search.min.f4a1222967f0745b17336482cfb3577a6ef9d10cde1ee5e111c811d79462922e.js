...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.9dd95e2aa075f3ba18b7dde6a3f37c3dd4d0d9293cffe1bd6b8cfb1309150354.js',function(){input.required=false;search();});}
