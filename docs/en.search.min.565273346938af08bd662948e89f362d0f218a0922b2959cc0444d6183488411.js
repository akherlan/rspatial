...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.cea9178e45dff55c794cfb66d34a4718c785be82ca928178434552101d9b1207.js',function(){input.required=false;search();});}
