...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.7bc5ab1597cda45f2036ca3a1f121546368e89d70a1cb686ec35dbc94afe865d.js',function(){input.required=false;search();});}
