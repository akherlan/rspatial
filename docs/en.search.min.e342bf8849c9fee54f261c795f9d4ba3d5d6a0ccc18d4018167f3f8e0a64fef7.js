...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.0e42d653f8338b471da9dce6f94d259969bf560a6d40322092936837238972c3.js',function(){input.required=false;search();});}
