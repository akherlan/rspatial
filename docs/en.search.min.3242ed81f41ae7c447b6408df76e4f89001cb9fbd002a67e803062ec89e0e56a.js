...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.3582a55343186fa3eb76171319223d3434324b545363d7c547ae8b47d7c74147.js',function(){input.required=false;search();});}
