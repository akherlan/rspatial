...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.9e973eae8c518cde7a8e8a0026cd356bdd83e4477ed0aa95cb129c7f1c3678dd.js',function(){input.required=false;search();});}
