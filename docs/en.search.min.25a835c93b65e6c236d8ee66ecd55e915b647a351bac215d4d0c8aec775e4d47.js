...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.b1bd594f4b81022c24d1d0a55ea34ca780e9b5cd252341650822db333def3d3c.js',function(){input.required=false;search();});}
