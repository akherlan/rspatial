...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.67a153863e111709632c6a639534b80f796ed6fe85a8ce62b9aecc463bba46da.js',function(){input.required=false;search();});}
