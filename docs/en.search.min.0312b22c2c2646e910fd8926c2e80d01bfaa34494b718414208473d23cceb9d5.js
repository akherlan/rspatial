...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.6273e67e3d0a9ca3d042dcfe2201dbd4b61521eeb656aa81d73e842d5277be69.js',function(){input.required=false;search();});}
