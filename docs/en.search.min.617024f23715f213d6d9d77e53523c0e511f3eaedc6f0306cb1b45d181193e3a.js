...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.e05f5cff006615cbaa7224719380f24175d2578cd0688e3c309f782fb57efdd8.js',function(){input.required=false;search();});}
