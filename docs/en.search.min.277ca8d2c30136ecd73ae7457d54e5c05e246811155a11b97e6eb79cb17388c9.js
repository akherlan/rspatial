...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.a8dba0acaa2a89bfa611c3435ef1f44884a6d9b95e83d0039cc5e9142572a3b9.js',function(){input.required=false;search();});}
