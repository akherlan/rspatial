...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.574a0788d9dd6e7b34169a1697cd041530907442688956a4b57676bb6033f875.js',function(){input.required=false;search();});}
