...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.53fb507ee15013ac4753123c0908820325a188ff337ae4328e6b64e58aa9a3dd.js',function(){input.required=false;search();});}
