...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.fb364db04e8f3ffb2966aaedaa866a4f14dc62adcd33ded52b72bdf26c4f11ac.js',function(){input.required=false;search();});}
