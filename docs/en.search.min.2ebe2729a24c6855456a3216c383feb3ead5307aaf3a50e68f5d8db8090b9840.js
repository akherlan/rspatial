...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.f83cce73271adb6bbab646724dc43a9983632289a112a8976bb14b1e31f76fa3.js',function(){input.required=false;search();});}
