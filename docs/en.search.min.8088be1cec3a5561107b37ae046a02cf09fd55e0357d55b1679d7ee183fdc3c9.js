...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.324cf9e944158652a1deeb79639b30632a602aed59c5878738ac4caab32b8b85.js',function(){input.required=false;search();});}
