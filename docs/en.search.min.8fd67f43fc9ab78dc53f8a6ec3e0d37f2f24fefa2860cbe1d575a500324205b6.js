...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.b530741df27abdb34868375424d35a699ed1d2376916d069a7927ab556935433.js',function(){input.required=false;search();});}
