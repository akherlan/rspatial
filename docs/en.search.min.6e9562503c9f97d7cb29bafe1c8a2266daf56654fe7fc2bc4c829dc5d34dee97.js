...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.8028cd822664500be5810b2e11024727b425ae26291cf36419fd375f1eb70bc2.js',function(){input.required=false;search();});}
