...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.02907cab83f9050c655563cd7e54082ed71e5756dad8dc84425e8bfd0c8e86a9.js',function(){input.required=false;search();});}
