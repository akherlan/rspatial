...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.4a616fa558efdf1408d8a5d72ee5ca6ac2b298e3c20ced737606e67ea3fa486d.js',function(){input.required=false;search();});}
