...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.48f54d45cc805aec0572c1a0d88dfbe14be4d51eb473dc0ad797c1e5fe009a31.js',function(){input.required=false;search();});}
