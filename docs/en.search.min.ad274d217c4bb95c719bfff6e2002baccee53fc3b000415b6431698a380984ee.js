...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.2cc2b6a358819d1d273ec53a309eb0cfb080351d4d5b1f5446ffa65a2c20ef11.js',function(){input.required=false;search();});}
