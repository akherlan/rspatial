...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.2279bde36ff425826e0d0103f999a3d9ca6112aa01cc06d7f18cb6b6abcd3050.js',function(){input.required=false;search();});}
