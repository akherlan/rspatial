...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.866b342c06797d677d340bc9b3bac40f50aa4fc5e601cf11a5d7de353437078e.js',function(){input.required=false;search();});}
