...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.1d077c8658c9043beca96b1889df6b4bb443703a00d29d78a39f747b5209e440.js',function(){input.required=false;search();});}
