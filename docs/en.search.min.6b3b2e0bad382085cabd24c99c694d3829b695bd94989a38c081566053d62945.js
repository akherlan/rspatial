...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.ff30c250aac9848db1e9fc3300f771617b95e02d3d41bb663bac30f6459a1abc.js',function(){input.required=false;search();});}
