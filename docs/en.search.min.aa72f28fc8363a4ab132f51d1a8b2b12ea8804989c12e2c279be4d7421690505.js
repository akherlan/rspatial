...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.32b29eccb8bc0ef824c6713fe64cda9c00167b3a1e27b52f1fdc5bd6d7f1cedf.js',function(){input.required=false;search();});}
