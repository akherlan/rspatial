...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.86dfd78e1e0d9305d4d9cb87cb06dfc5175418edcecdaa098a6904ccd9b03614.js',function(){input.required=false;search();});}
