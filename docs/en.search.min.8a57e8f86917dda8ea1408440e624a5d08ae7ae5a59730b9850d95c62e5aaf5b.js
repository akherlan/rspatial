...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.8021e98477d7dcb58b01e0052fb5a7b55328be16b46904f8815329af812d7d76.js',function(){input.required=false;search();});}
