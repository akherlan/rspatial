...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.a3201975024dd8dcd684565400db5c678a2751f182b36ab285e2d01db6b1e7f7.js',function(){input.required=false;search();});}
