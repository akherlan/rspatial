...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.fc058cdb00fcf30552db6b43d518d73f60080830df9e679135c20a98a33a512d.js',function(){input.required=false;search();});}
