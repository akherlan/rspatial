...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.db52cd421935c69285e9a51c1d36b7acc140697760dd4810bdf11c21b3e102e8.js',function(){input.required=false;search();});}
