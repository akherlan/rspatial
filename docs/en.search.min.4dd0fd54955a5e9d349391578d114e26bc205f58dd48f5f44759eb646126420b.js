...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/rspatial/flexsearch.min.js');loadScript('/rspatial/en.search-data.min.b4ae260a0b57d6732db48cbf0a3b093e7c9ce86e635740de38313c751c9f860f.js',function(){input.required=false;search();});}
